...
public:
    ...
    QCommandLinkButton *newGameButton;
    QCommandLinkButton *loadGameButton;
    QCommandLinkButton *highScoreButton;
    ...
    void setupUi(QMainWindow *Menu)
    {
        ...
        Menu->resize(900, 636);
        windowMain = new QWidget(Menu);
        windowMain->setObjectName(QStringLiteral("windowMain"));
        verticalLayoutWidget = new QWidget(windowMain);
        verticalLayoutWidget->setObjectName(QStringLiteral("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(290, 260, 245, 246));
        verticalLayout = new QVBoxLayout(verticalLayoutWidget);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        newGameButton = new QCommandLinkButton(verticalLayoutWidget);
        newGameButton->setObjectName(QStringLiteral("newGameButton"));
        QPalette palette;
        QBrush brush(QColor(0, 0, 0, 255));
        brush.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::WindowText, brush);
        QBrush brush1(QColor(255, 12, 12, 255));
        brush1.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Button, brush1);
        QBrush brush2(QColor(255, 140, 140, 255));
        brush2.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Light, brush2);
        QBrush brush3(QColor(255, 76, 76, 255));
        brush3.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Midlight, brush3);
        QBrush brush4(QColor(127, 6, 6, 255));
        brush4.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Dark, brush4);
        QBrush brush5(QColor(170, 8, 8, 255));
        ...
        QBrush brush7(QColor(255, 133, 133, 255));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("../iconMenu/bomb.png"), QSize(), QIcon::Normal, QIcon::Off);
        newGameButton->setIcon(icon);
        newGameButton->setIconSize(QSize(40, 40));

        verticalLayout->addWidget(newGameButton);

        loadGameButton = new QCommandLinkButton(verticalLayoutWidget);
        ...
        loadGameButton->setPalette(palette1);
        loadGameButton->setFont(font);
        QIcon icon1;
        icon1.addFile(QStringLiteral("../iconMenu/download.png"), QSize(), QIcon::Normal, QIcon::Off);
        loadGameButton->setIcon(icon1);
        loadGameButton->setIconSize(QSize(40, 40));

        verticalLayout->addWidget(loadGameButton);

        highScoreButton = new QCommandLinkButton(verticalLayoutWidget);
        ...
        highScoreButton->setPalette(palette2);
        highScoreButton->setFont(font);
        QIcon icon2;
        icon2.addFile(QStringLiteral("../iconMenu/trophy.png"), QSize(), QIcon::Normal, QIcon::Off);
        highScoreButton->setIcon(icon2);
        highScoreButton->setIconSize(QSize(40, 40));

        verticalLayout->addWidget(highScoreButton);

        exitButton = new QCommandLinkButton(verticalLayoutWidget);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral("../iconMenu/quit.png"), QSize(), QIcon::Normal, QIcon::Off);
        exitButton->setIcon(icon3);
        exitButton->setIconSize(QSize(40, 40));

        verticalLayout->addWidget(exitButton);

        Menu->setCentralWidget(windowMain);
    ...
    void retranslateUi(QMainWindow *Menu)
    {
        ...
        loadGameButton->setText(QApplication::translate("Menu", "Load game", 0));
        highScoreButton->setText(QApplication::translate("Menu", "High Score", 0));
        exitButton->setText(QApplication::translate("Menu", "Exit game", 0));
    } // retranslateUi
